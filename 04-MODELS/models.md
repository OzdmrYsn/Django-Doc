...
## HTML'DE GÖSTERMEK
index.html dosyasında oluşturulan model bu şekilde yazdırılır. <br>
<img src="/04-MODELS/img/model_HTML.PNG"> <br> <br>

## MODEL'DE RESİM OLUŞTURMAK
Ana dizinde **media** adında bir adet klasör oluşturmamız gerekiyor. <br> <br>

Model oluştururken imageFieled oluşturarak, kullanıcımıza resim ekletebiliriz. <br> <br>
<img src="/04-MODELS/img/image_models.PNG"> <br> <br>

**settings.py** içerisinde media yolunu belirleyiniz <br>
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media/')
os hatasında import os ile os yolunu dahil etmemiz gerekiyor <br>

<img src="/04-MODELS/img/baseDirImage.PNG">

<br> <br>

**urls.py** içerisinde ise bir ek ayar yaparak gerekli ayarları sonlandırıyoruz <br>
...
<img src="/04-MODELS/img/urlImageControls.PNG">

<br><br>

**HTML** içserisinde ise oluşturulan resim ekteki gibi çekilmektedir. <br>
<img src="/04-MODELS/img/indexImage.PNG">
