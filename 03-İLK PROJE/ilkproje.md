...
**Bu yapılan işlemler aynı mantıkla js dosyasıları içinde geçerlidir.** <br>

## MODÜLER YAPIDA HEADER VE FOOTER
Header ve footeri bütün sayfalara dağıtmak için templates içerisine base.html adında örnekteki gibi bir .html dosyası oluşturalım. <br>
<img src="img/base.PNG"> <br> <br>
Artık genel sayfaların kullanımı aşşağıdaki gibi olacaktır <br> <br>
